package com.mercadolibre.bootcamp_gabriel_duarte.config;
...
import static com.mercadolibre.bootcamp_gabriel_duarte.util.ScopeUtils.SCOPE_VALUE;
import static com.mercadolibre.bootcamp_gabriel_duarte.util.ScopeUtils.isLocalScope;
...
public class SpringDocConfig {
	...
	public OpenAPI customOpenAPI(@Value("${app.title}") String appName, @Value("${app.description}") String description, @Value("${app.version}") String version) {
		OpenAPI api = new OpenAPI().info(new Info().title(appName)
				...
				.contact(new Contact().name("bootcamp-gabriel-duarte")
						.email("gabriel.duarte@mercadolivre.com")));
